...
import UnitCaps from './components/UnitCaps';
import Guidelines from './components/Guidelines';
import Eligibility from './components/Eligibility';
import EligibleComponents from './components/EligibleComponents';
...
const IntegratedColdChain = () => {
  ...
  const tabs = ['EOI Timeline', 'Unit Caps / Budget', 'Guidelines', 'Eligibility', 'Eligible/Ineligible Components', 'Timelines', 'Checklist', 'FAQ'];
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  <tr>
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500">Food Safety and Quality Assurance Infrastructure (FTL)</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500">From 10:00 AM of 09-10-2023 to 05:00 PM of 15-12-2023</td>
                  </tr>
                  <tr>
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500">On or before 05:00 PM on 22-22-2023</td>
                  </tr>
                  <tr>
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500">Others - ₹ 20,000/-</td>
                  </tr>
                  <tr>
        ...
        {/* Unit Caps Section */}
        {activeTab === 'Unit Caps / Budget' && <UnitCaps />}
        ...
        {/* Eligible/Ineligible Components Section */}
        {activeTab === 'Eligible/Ineligible Components' && <EligibleComponents />}
