...
const Navbar = () => {
  ...
  return (
    <header className="border">
      ...
      <div className="border-b border-gray-300/30 py-1 text-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-end gap-2 sm:gap-6 text-gray-700 text-xs sm:text-sm overflow-hidden">
            ...
            <span className="border-l border-gray-400/50 pl-2 sm:pl-6 whitespace-nowrap">+91987230494</span>
            <span className="border-l border-gray-400/50 pl-2 sm:pl-6 whitespace-nowrap">Mon-Fri 9am-5pm</span>
          </div>
        </div>
      </div>
          ...
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex-shrink-0">
              <button onClick={() => router.push('/')} className="flex items-center">
                ...
                <span className="ml-2 text-lg sm:text-xl font-semibold text-gray-800">Mind Meld</span>
              </button>
            </div>
                ...
                <div className="flex-1 overflow-y-auto py-2">
                  {menuItems.map((item, index) => (
                    <button
                      ...
                      className="flex items-center w-full px-4 py-3 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 active:bg-gray-100 transition-colors duration-150"
                    >
                      {item.icon}
                      {item.name}
                    </button>
