...
const Hero = () => {
  return (
    <div className="relative w-full min-h-[600px] bg-gradient-to-r from-[#9AADC4] to-[#E2EAEE] px-4 sm:px-6 lg:px-8 py-16 rounded-bl-[5rem]">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] mt-8 lg:mt-0">
            {/* Background shape */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#073952] to-[#E2EAEE] rounded-[2rem] transform rotate-3"></div>
